            ...
            <div id="edit_details">
                <div class="ui one column doubling stackable">
                    <div class="column admin_basic_detail1 personal_detail_con">
                        ...
                        @if(isset($reregister))
                            {!! Form::open(array('route' => ['Laralum::booking.registration.personalDetails.store', 'user_id' => $user->id, 'reregister' => $reregister] , 'id' => 'bookingProcessForm', 'class'=>'' ,'files'=>true,'method'=>'post')) !!}
                            @else
                            {!! Form::open(array('route' => ['Laralum::booking.registration.personalDetails.store', 'user_id' => $user->id], 'id' => 'bookingProcessForm', 'class'=>'' ,'files'=>true,'method'=>'post')) !!}
                        @endif
                        ...
                        <div class="segment form_spacing_inn">
                            ...
                            <div class="about_sec signup_bg">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control required" id="patient_type"
                                            name="userProfile[patient_type]" id="patient_type" autofocus required {{ $profile->id != null ? 'disabled' : '' }}>
                                ...
                                @if($profile->id != null)
                                <input type="hidden" value="{{ $profile->patient_type }}" name="userProfile[patient_type]">
                                @endif
                                <div class="block_divide">
                                    ...
                                    <div class="form-group">
                                        <input required class="user_confirm datepicker form-control required"
                                               type="text"
                                               value="{{ $profile->dob != null ? old('userProfile.dob',date("d-m-Y", strtotime($profile->dob))) : "" }}" id="dob"
                          ...
                          <div class="form-group">
                            <input required class="user_confirm form-control required" type="text" value="{{ old('userProfile.age', $profile->age) }}" max="100" maxlength="3" min="1" id="age" name="userProfile[age]" placeholder="Age*">
                                ...
                                <div class="block_divide">
                                    ...
                                    <div class="form-group">
                                        <input required id="referral_source"
                                ...
                                <div class="block_divide">
                                    ...
                                    <div class="form-group ui-widget">
                                        <!-- <input required class="user_confirm form-control required" type="text"
                                               ...
                                               value="{{ old('userAddress.state', $address->state) }}" id="state"
                                               placeholder="State*"> -->
