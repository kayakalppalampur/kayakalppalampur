                ...
                <div class="ui one column doubling stackable">
                    <div class="column admin_basic_detail1">
                        <div class="segment form_spacing_inn">
                            <div class="about_sec signup_bg booking_py_detail">
                                <h3 class="title_3">Payment Details</h3>
                                {!! Form::open(array('route' => ['Laralum::booking.registration.payment.store', 'user_id'=> $booking->id], 'id' => 'bookingProcessForm','files'=>true,'method'=>'post')) !!}
                                ...
                                <input type="text" class="form-control" id="amount"
                                       ...
                                       placeHolder="Amount to be paid" style="width:50%"
                                       name="amount"/>
                                    ...
                                    <div class="pymnt_opt_row">
                                        <div class="pymt_inn">
                                            <input type="radio" disabled name="payment_method"
                                                   value="{{ \App\Transaction::PAYMENT_METHOD_CREDIT }}"/><span>Credit Card</span>
                                        </div>
                                    </div>
                                    <div class="pymnt_opt_row">
                                        <div class="pymt_inn">
                                            <input type="radio" disabled name="payment_method"
                                                   value="{{ \App\Transaction::PAYMENT_METHOD_DEBIT }}"/><span>Debit Card</span>
                                        </div>
                                    </div>
                                    <div class="pymnt_opt_row">
                                        <div class="pymt_inn">
                                            <input type="radio"
                                                   ...
                                                   name="payment_method" disabled/><span>Net Banking</span>
                                        </div>
                                    </div>
                                    <div class="pymnt_opt_row">
                                        <div class="pymt_inn">
                                            <input value="{{ \App\Transaction::PAYMENT_METHOD_MOBILE_PAYMENTS }}"
                                                   type="radio" disabled
                                                   name="payment_method"/><span>Mobile Payments</span>
                                        </div>
                                    </div>
                                    <div class="pymnt_opt_row">
                                        <div class="pymt_inn">
                                            <input type="radio" value="{{ \App\Transaction::PAYMENT_METHOD_WALLET }}"
                                                   name="payment_method" checked/><span>Cash</span>
                                        </div>
                                    </div>
                                </div>
                                <p class="permission_con">
                                    <button class="ui button no-disable" type="submit"> AGREE & GO TO NEXT »</button>
                                </p>
                                {!! Form::close() !!}
                            </div>
                        </div>
