...
@section('breadcrumb')
    <div class="ui breadcrumb">
        ...
        <div class="active section">{{  trans('laralum.email_templates_create') }}</div>
    </div>
@endsection
    ...
    <div class="ui one column doubling stackable">
        <div class="ui very padded segment">
            <div class="column about_sec hospital_info role_edt">
                <form enctype="multipart/form-data"  id="demo-form2" data-parsley-validate class="form form form_cond_lft" method="post" action="{{ url('admin/email-templates/store') }}">
                    {!! csrf_field() !!}
                    {{--<div class="field ">
                    ...
                    <div class="field ">
                        <label class="" for="event_id">Event<span class="required">*</span>
                        </label>
                    ...
                    <div class="field" id="date-div" style="display:none;">
                        <label class="" for="sent_date_time">Choose date and time<span class="required">*</span> </label>
                        <input name="sent_date_time" type="text" value="{{ old('sent_date_time') }}" class="datetimepicker form-control">
                    </div>

                    <div class="field ">
                        <label class="" for="from_email">Email From <span class="required">*</span> </label>
                        <input name="from_email" type="text" value="{{ old('from_email') }}" required="required" class="form-control">
                    </div>

                    <div class="field ">
                        <label class="" for="from_name">From Name <span class="required">*</span> </label>
                        <input name="from_name" type="text" value="{{ old('from_name') }}" required="required" class="form-control">
                    </div>

                    <div class="field ">
                        <label class="" for="reply_to_email">Reply to Email <span class="required">*</span> </label>
                        <input name="reply_to_email" type="text" value="{{ old('reply_to_email') }}" required="required" class="form-control">
                    </div>

                    <div class="field ">
                        <label class="" for="name">Subject<span class="required">*</span> </label>
                        <input name="subject" type="text" value="{{ old('subject') }}" required="required" class="form-control">
                    </div>

                    <div class="field ">
                        <label class="" for="name">Send Email<span class="required">*</span> </label>
                       {{-- <label class="switch">
                            <input type="checkbox" name="status" value="{{ \App\EmailTemplate::STATUS_ENABLE }}">
                            <div class="slider round"></div>
                        </label>--}}
                         <div class="pymnt_opt_row">
                             <div class="pymt_inn">
                                <input type="radio" name="status" value="{{ \App\EmailTemplate::STATUS_DISABLE }}">
                                <span> Disable </span>
                             </div>
                         </div>
                        ...
                        <div class="pymnt_opt_row">
                            <div class="pymt_inn">
                                <input type="radio" name="status" value="{{ \App\EmailTemplate::STATUS_ENABLE }}">
                                <span>Enable</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="field ">
                        <label class="" for="name">Content <span class="required">*</span>
                        </label>
                        ...
                        <textarea id="description" name="content" class="">{{ old('content') }}</textarea>
                    </div>
...
<script>
    $("[id^=text_]").click(function () {
        ...
        console.log('des'+CKEDITOR.instances.description.getData());
