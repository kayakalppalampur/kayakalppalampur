...
@section('content')
    ...
    <div class="token-receipt" id="mySelector" style="width:1000px;max-width:1000px;">
        <div class="receipt-for">
            <p><a id="print" class="btn btn-primary ui button blue">Print</a> <a id="back" class="btn btn-primary ui button blue" href="{{ url('/admin/booking/discharge-patient-billing'/*/'.$user->id*/) }}">Back</a></p>
        </div>
        <div class="booking_info_page noc-pop">
            ...
            <div class="content_Box">
                <div class="content_BoxIN">
                    <div class="noc_wrap">
						<h3>N.O.C. (No Objection Certificate)</h3>
                        <h4>PATIENT ID: {{ $user->userProfile->kid }}</h4>
                        <div class="noc-certi">
                            <div class="noc-detail">
                                <label>First name:</label>
                                <div class="name-noc">{{ $user->userProfile->first_name }}</div>
                            </div>


                            <div class="noc-detail">
                                <div class="noc-age-sex">
                                    <label>Age:</label>
                                    <div class="ag-se-noc">{{ $user->userProfile->getAge() }}</div>
                                </div>
                                <div class="noc-age-sex">
                                    <label>Sex:</label>
                                    <div class="ag-se-noc">{{ $user->userProfile->getGenderOptions($user->userProfile->gender) }}</div>
                                </div>
                            </div>
                        </div>
                       <div class="bar-code">   	
