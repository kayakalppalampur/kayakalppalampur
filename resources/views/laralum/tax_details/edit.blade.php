...
@section('breadcrumb')
    <div class="ui breadcrumb">
        ...
        <div class="active section">Edit Tax Type</div>
    </div>
@endsection
@section('title','Edit Tax Type')
@section('icon', "edit")
@section('subtitle', 'Edit Tax Type: '.$model->tax_type)
@section('content')
    ...
    <div class="ui very padded segment">
        <div class="column about_sec hospital_info role_edt">
            <form class="form form form_cond_lft" method="POST">
                {{ csrf_field() }}
                <div class="field">
                    <label class="" for="tax_type">Tax Type<span class="required">*</span> </label>
                    <input name="tax_type" type="text" value="{{ old('tax_type', $model->tax_type) }}" required="required" class="form-control">
                </div>

                <div class="field">
                    <label class="" for="tax_amount">Tax Amount (%)<span class="required">*</span> </label>
