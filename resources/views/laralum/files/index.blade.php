                                  ...
                                  <div class="extra content">
                                    ...
                                    <div class="ui dropdown">
                                      ...
                                      <div class="menu">
                                        ...
                                        <a href="{{ route('Laralum::documents_edit', ['slug' => $slug]) }}" class="item no-disable">{{ trans('laralum.documents_edit') }}</a>
                                        <a href="{{ route('Laralum::documents_delete', ['slug' => $slug]) }}" class="item no-disable">{{ trans('laralum.documents_delete_document') }}</a>
                                        <a href="{{ route('Laralum::files_delete', ['file' => $file]) }}" class="item no-disable">{{ trans('laralum.files_delete_file') }}</a>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="ui fluid orange card">
                                  ...
                                  <div class="extra content">
                                    ...
                                    <div class="ui dropdown">
                                      {{ trans('laralum.options') }}
                                      <div class="menu">
                                        <a href="{{ route('Laralum::documents_create', ['file' => $file]) }}" class="item no-disable">{{ trans('laralum.files_create_document') }}</a>
                                        <a href="{{ route('Laralum::files_delete', ['file' => $file]) }}" class="item no-disable">{{ trans('laralum.files_delete_file') }}</a>
                                      </div>
                                    </div>
                                  </div>
