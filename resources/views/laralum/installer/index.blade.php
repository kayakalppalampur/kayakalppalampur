						                            ...
						                            <div class="menu">
						                                @foreach(Laralum::locales() as $locale => $locale_info)
						                                	@if($locale_info['enabled'])
																<div class="item no-disable" data-value="{{ $locale }}">@if($locale_info['type'] == 'flag')<i class="{{ $locale_info['type_data'] }} flag"></i>@elseif($locale_info['type'] == 'image')<img style="display: inline-block;" class="ui image"  height="12" src="{{ $locale_info['type_data'] }}">@endif{{ $locale_info['name'] }}</div>
															@endif
						                                @endforeach
						                            </div>
						                        </div>
									...
									<div class="fields">
										<div class="field">
											...
											<div class="ui fluid search selection dropdown">
												...
												<div class="menu">
													<div class="item no-disable" data-value="smtp">SMTP</div>
													<div class="item no-disable" data-value="mail">Mail</div>
													<div class="item no-disable" data-value="sendmail">Sendmail</div>
													<div class="item no-disable" data-value="mailgun">Mailgun</div>
													<div class="item no-disable" data-value="mandrill">Mandrill</div>
													<div class="item no-disable" data-value="ses">SES</div>
													<div class="item no-disable" data-value="sparkpost">Sparkpost</div>
													<div class="item no-disable" data-value="log">Log</div>
												</div>
											</div>
										</div>
										<div class="field">
