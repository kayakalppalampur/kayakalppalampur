                            ...
                            <div class="ui stackable grid">
                                <div class="column">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label>DATE</label>
                                            <input type="text" name="start_date" placeholder="Default Date" class="form-control datepicker" value="{{ date("d-m-Y") }}"/></div>
                                        <div class="col-md-6">
                                            <label>REPEAT (Enter number of days i.e. 1 or 2 or 6)</label>
                                            <input type="text" name="repeats" class="form-control"
                                                   placeHolder="Show repeat options"/></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="column">
                                    <div class="scroll-tab-in">
                                        <table class="ui table table_cus_v last_row_bdr">
                                            <tr>
                                                <th> <div class="col-md-3"><label> >>Breakfast(8:30 AM)</label></div> </th>
                                                @php $i = 0; @endphp
                                                @foreach(\App\KitchenItem::getItems(\App\DietChartItems::TYPE_BREAKFAST, 7) as $item)
                                                    ...
                                                    <td>
                                                        <div class="pull-left select-div">
                                                            ...
                                                            <select class="form-control item_list_{{ \App\DietChartItems::TYPE_BREAKFAST }}"
                                                                    name="item_{{ $item->id }}-type_{{ \App\DietChartItems::TYPE_BREAKFAST }}">
                                            ...
                                            <tr>
                                                <th> <div class="col-md-3"><label>>>Lunch(12:30 AM)</label></div> </th>
                                                @php $i = 0; @endphp
                                                @foreach(\App\KitchenItem::getItems(\App\DietChartItems::TYPE_LUNCH, 7) as $item)
                                                    ...
                                                    <td>
                                                        <div class="pull-left select-div">
                                                            <label>Item {{ $loop->iteration }}</label>
                                                            <select class="form-control item_list_{{ \App\DietChartItems::TYPE_LUNCH }}"
                                                                    name="item_{{ $item->id }}-type_{{ \App\DietChartItems::TYPE_LUNCH }}">
                                                                <option value="">Select Item</option>
                                            ...
                                            <tr>
                                                <th> <div class="col-md-3"><label>>>Post Lunch (4:00 PM)</label></div> </th>
                                                @php $i = 0; @endphp
                                                @foreach(\App\KitchenItem::getItems(\App\DietChartItems::TYPE_POST_LUNCH, 7) as $item)
                                                    ...
                                                    <td>
                                                        <div class="pull-left select-div">
                                                            <label>Item {{ $loop->iteration }}</label>
                                                            <select class="form-control item_list_{{ \App\DietChartItems::TYPE_POST_LUNCH }}"
                                                                    name="item_{{ $item->id }}-type_{{ \App\DietChartItems::TYPE_POST_LUNCH }}">
                                                                <option value="">Select Item</option>
                                            ...
                                            <tr>
                                                <th> <div class="col-md-3"><label>>>Dinner(7:00 AM)</label></div> </th>
                                                @php $i = 0; @endphp
                                                @foreach(\App\KitchenItem::getItems(\App\DietChartItems::TYPE_DINNER, 7) as $item)
                                                    ...
                                                    <td>
                                                        <div class="pull-left select-div">
                                                            <label>Item {{ $loop->iteration }}</label>
                                                            <select class="form-control item_list_{{ \App\DietChartItems::TYPE_DINNER }}"
                                                                    name="item_{{ $item->id }}-type_{{ \App\DietChartItems::TYPE_DINNER }}">
                                                                <option value="">Select Item</option>
                                            ...
                                            <tr class="last">
                                                <th class="no_bdr_btm"> <div class="col-md-3"><label>>>Special(8:30 PM)</label></div> </th>
                                                @php $i = 0; @endphp
                                                @foreach(\App\KitchenItem::getItems(\App\DietChartItems::TYPE_SPECIAL, 7) as $item)
                                                    ...
                                                    <td>
                                                        <div class="pull-left select-div">
                                                            <label>Item {{ $loop->iteration }}</label>
                                                            <select class="form-control item_list_{{ \App\DietChartItems::TYPE_SPECIAL }}"
                                                                    name="item_{{ $item->id }}-type_{{ \App\DietChartItems::TYPE_SPECIAL }}">
                                                                <option value="">Select Item</option>
