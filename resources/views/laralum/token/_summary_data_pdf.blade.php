...
<div class="table_head_lft" style="margin-top: 10px;">
...
@include('laralum.token.discharge_data_summary_pdf')

@include('laralum.token.vital_data_summary_pdf')

@include('laralum.token.physiotherpy_vital_data_summary_pdf')

@include('laralum.token.ayurved_vital_data_summary_pdf')

@include('laralum.token.lab_data_summary_pdf')
