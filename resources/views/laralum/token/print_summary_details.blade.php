...
@section('content')
    ...
    <style>
        @font-face {
            ...
            font-style: normal;
            font-weight: normal;
            src: url({{ url('/fonts/k010/k010.TTF') }}) format('truetype');
        }
    ...
    <div class="detail_container" id="mySelector" style="width:1000px;max-width:1000px;">
        <div class="receipt-for">
            ...
            <a id="back" class="btn btn-primary ui button blue" href="{{ isset($back_url) ? $back_url : url('/admin/summary/'.$booking->id) }}">Back</a>
            </p>
        </div>
    <div class="token-detail-box token_summary" id="mySelector">
        ...
        <div class="">
            ...
            <!-- @if($ashtvidh->id != null)
                <div class="table_head_lft ada">
                    <table class="ui table table_cus_v bs">
                        <tbody>

                        <tr>
                            <th><h5>{{ trans('laralum.ashtvidh_pariksha') }}</h5></th>
                        </tr>
                        <tr>
                            @if($ashtvidh->pulse)
