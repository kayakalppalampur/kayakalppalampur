                                        ...
                                        <div class="ui top left pointing dropdown">
                                            ...
                                            <div class="menu">
                                                @if(count($post->views) > 0)
                                                    <a href="{{ route('Laralum::posts_graphics', ['id' => $post->id]) }}" class="item no-disable">{{ trans('laralum.statistics') }}</a>
                                                @endif
                                                <a href="{{ route('Laralum::posts_edit', ['id' => $post->id]) }}" class="item no-disable">{{ trans('laralum.posts_edit') }}</a>
                                                <a href="{{ route('Laralum::posts_delete', ['id' => $post->id]) }}" class="item no-disable">{{ trans('laralum.posts_delete') }}</a>
                                            </div>
                                        </div>
                                    </span>
