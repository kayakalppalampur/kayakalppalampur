...
@section('breadcrumb')
    <div class="ui breadcrumb">
        ...
        <div class="active section">{{ trans('laralum.discount_offers_edit_title') }}</div>
    </div>
@endsection
@section('title', trans('laralum.discount_offers_edit_title'))
@section('icon', "edit")
@section('subtitle', trans('laralum.discount_offers_edit_title_name', ['name' => $row->title]))
@section('content')
