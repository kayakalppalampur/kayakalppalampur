...
@section('content')
    ...
    <div class="ui one column doubling stackable grid container" id="mySelector" style="width:1000px;max-width:1000px;">
        <div class="receipt-for">
            <p>@if(isset($print)) <a id="print" class="btn btn-primary ui button blue">Print</a> <a id="back" class="btn btn-primary ui button blue" href="{{ url('/admin/lab-tests') }}">Back</a>  @endif
            </p>
        </div>
        <div class="token_treatment_con" style="max-width: 100% !important;">
            <div class="column">
