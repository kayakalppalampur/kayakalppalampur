<div id="check_all" class="ui button no-disable">{{ trans('laralum.check_all') }}</div>
<div id="uncheck_all" class="ui button no-disable">{{ trans('laralum.uncheck_all') }}</div><br><br>
        <?php $found = false; ?>
