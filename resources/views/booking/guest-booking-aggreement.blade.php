        ...
        <div class="main_wrapper">
            ...
            <div class="main_content_area">
                <div id="signup_wizard">
                    ...
                    @endif
                {!! Form::open(array('route' => 'guest.booking.aggreement.store', 'id' => 'bookingProcessForm','files'=>true,'method'=>'post')) !!}
                                    ...
                                    <div class="about_sec white_bg signup_bg">
                                        ...
                                        <div id="go-nxt" class="form_preview-con">
                                            <div class="form-group">
                                                <div class="preview_title">Agreement</div>
                                                <div  class="text-center aggreement-details">
                                                <p>
                                                I {{ $user->userProfile->first_name }} {{ $user->userProfile->last_name }} S/O, D/O, W/O {{ $user->userProfile->relative_name }} have read the conditions mentioned above and also those mentioned in the brochure, all of which I heartily accept, and solemnly undertake that I shall abide by the rules & conventions of KAYAKALP (HRIYN) faithfully. Also, nature of treatment at the institute and the possible benefits and risk are understood by me. I opt for the treatment on my own accord. In the event of complications and / or adverse reactions arising of the treatment during the stay at KAYAKALP (HRIYN), the management will not be responsible and it has the right to shift / refer me to a suitable medical institution for necessary treatment, at my cost.</p></div> <p class="col-md-4 col-md-offset-8">
