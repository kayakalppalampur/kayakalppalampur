        ...
        <div class="main_content_area">
            <div id="signup_wizard">
                ...
                {!! Form::open(array('route' => 'guest.booking', 'id' => 'bookingProcessForm','files'=>true,'method'=>'post')) !!}
                    ...
                    <h2><i class="fa fa-user-circle-o" aria-hidden="true"></i>Personal Detail</h2>
                    <section>
                        <div class="pro_main_content">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="about_sec white_bg signup_bg">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <input class="user_confirm form-control required" type="text" name="userAddress[state]" value="{{ old('userAddress.state') }}"  id="city" placeholder="State*">
                                            </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="userAddress[country]" class="form-control required" id="country">
                                                ...
                                                @foreach($countries as $country)
                                                    ...
                                                    <option {{ old('userAddress.country') == $cc_field_value ? 'selected' : "" }} class="item" value="{{ $cc_field_value }}">{{ $country }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="about_sec white_bg signup_bg">
                                        ...
                                        <div class="form-group">
                                            <button type="button" class="save_btn_signup form-control">YEAH, IT IS ALL FINE, GO AHEAD »  </button>
                                        </div>
                                    </div>
                                </div>
                            </div>
