...
$data = [
    ...
    'issues' => [
        ...
        'create' => [
            'allowed'           =>  true,
            'hidden' => ['status', 'type', 'created_at', 'updated_at', 'deleted_at', 'created_by', 'id'],
    ...
    'buildings' => [
        ...
        'create' => [
            'allowed'       =>  true,
            'hidden'        =>  ['created_at', 'updated_at', 'deleted_at', 'created_by', 'id'],
            'auth_users'    =>  ['created_by'],
            'times'         =>  ['created_at', 'updated_at'],
            'validator'         =>  [
                'name'          => 'required|max:255',
            ...
            'relations'         =>  [
                ...
                'type'      =>  [
                    'data'  =>  Laralum::dropdown('building_types'),
                    'value' =>  'value',
                    'show'  =>  'show',
                ],
            ],
