...
$dropdowns = [
    ...
    'building_types' =>  [
        ...
        [
            'value' =>  2,
            'show'  =>  'Deluxe Double Bed',
        ],
        [
            'value' =>  3,
            'show'  =>  'Double Bed Room',
        ],
        [
            'value' =>  4,
            'show'  =>  'Dormitory',
    ...
    'users' => \App\User::getDropDownList(),
    'offerType' => \App\DiscountOffer::getTypeOptionsDropdwon(),
    'usersedit' => \App\User::getDropDownList(\Session::get('department_id')),
    'products' => \App\KitchenItem::getDropDownList(),
    'duration_types' => \App\Treatment::getDurationTypesDropDownList(),
    'departments' => \App\Department::getDropDownList(),
    'meal_type' => \App\DietChartItems::getTypeDropDownList(),
    'labTypes' => \App\LabTest::getTypeDropdownList(),
    'staffDepartments' => \App\StaffDepartment::getDropDownList(),
    'categories' => \App\LabTest::getCategoryDropdownList(),
    'stock_actions' => \App\ItemQuantityLog::getActionDropDownList()
